...
export const about = {
  ...
  body: [
    ...
    "During my internship at Publicis Sapient, I built and delivered a full-stack AI battery-recommendation product to a global automotive battery manufacturer as the sole intern on the project — owning the React / AWS Amplify front end and a Python / FastAPI service end to end. Right now I'm an AI Engineer intern at Oraczen, a startup building agentic AI for enterprise procurement, where I've built a multi-tier insight engine that surfaced 16 of 17 analyst-validated insights from a $2.3B supplier dataset (vs 1 of 17 for a brute-force LLM baseline) at ~3× lower cost, a log-probability confidence scorer, and agent-to-agent transaction workflows.",
    ...
    "Outside of my internship, projects, and coursework, I've led Calculus II supplemental instruction at USC for the past 2.5 years, and I unwind with sports and gaming.",
  ],
  stats: [
